...
public class TeleportdoZamku : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        {
            przeniesGracza = new Vector3(ileMaSkoczycX, 0, gracz.transform.position.z) ;
            gracz.transform.position = przeniesGracza;
